...
admin_route.get('/searchusers',auth.isLogin,adminController.searchUsers)
admin_route.get('/searchproducts',auth.isLogin,adminController.searchProducts)
admin_route.get('/searchcategories',auth.isLogin,adminController.searchCategories)
